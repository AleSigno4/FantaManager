        ...
        >
          <div className="w-52 flex flex-col h-full flex-1">
            ...
            <ul className="space-y-2 flex-1 flex flex-col overflow-y-auto">
              ...
              <li><a href="#" className="text-white text-2xl hover:text-green-300">Player List</a></li>
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="bg-green-900 p-6 rounded-lg border-4 border-emerald-700 shadow-lg">
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-4">
                    <div className="flex flex-col items-center justify-center mt-4">
                      <img src={teams[0].logo} alt={teams[0].name} className="w-36 h-48 object-contain" />
                      <h3 className="text-lg font-bold text-white">{teams[0].name}</h3>
                    </div>
                    <div className="flex flex-col items-center justify-center mt-4">
                    ...
                    <div className="flex flex-col items-center justify-center mt-4">
                      <img src={teams[1].logo} alt={teams[1].name} className="w-36 h-48 object-contain" />
                      <h3 className="text-lg font-bold text-white">{teams[1].name}</h3>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-green-900 p-6 rounded-lg border-4 border-emerald-700 shadow-lg">
                  ...
                  <div className="grid grid-cols-3 gap-4 mt-4">
                    ...
                    <div className="flex flex-col items-center justify-center mt-4">
                      <img src={teams[2].logo} alt={teams[2].name} className="w-36 h-48 object-contain" />
                      <h3 className="text-lg font-bold text-white">{teams[2].name}</h3>
                    </div>
                  </div>
                </div>
                  ...
                  <div className="grid grid-cols-2 gap-4 mt-4">
                    <div className="flex flex-col items-center text-center justify-center group">
                      <button className="cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width={110} height={110} viewBox="0 0 24 24" color="lightgray" fill="none" strokeWidth={0.75} stroke="currentColor" strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-building-stadium group-hover:stroke-green-400 transition-colors duration-300">
                        ...
                        <h3 className="text-lg font-bold text-white group-hover:text-green-400 transition-colors duration-300">
                          Stadium <span className="text-gray-400">LV{teams[0].stadium_level}</span>
                        </h3>
                      </button>
                    </div>
                    <div className="flex flex-col items-center text-center justify-center group">
                      <button className="cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width={110} height={110} viewBox="0 0 24 24" color="lightgray" fill="none" stroke="currentColor" strokeWidth={0.75} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-building-store group-hover:stroke-green-400 transition-colors duration-300">
                          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                          <path d="M3 21l18 0" />
                      ...
                      <h3 className="text-lg font-bold text-white group-hover:text-green-400 transition-colors duration-300">
                        Store <span className="text-gray-400">LV{teams[0].store_level}</span>
                      </h3>
                    </div>
                    <div className="flex flex-col items-center text-center justify-center group">
                      <button className="cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width={110} height={110} viewBox="0 0 24 24" color="lightgray" fill="none" stroke="currentColor" strokeWidth={0.75} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-building group-hover:stroke-green-400 transition-colors duration-300">
                          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                      ...
                      <h3 className="text-lg font-bold text-white group-hover:text-green-400 transition-colors duration-300">
                        HQ <span className="text-gray-400">LV{teams[0].hq_level}</span>
                      </h3>
                    </div>
                    <div className="flex flex-col items-center text-center justify-center group">
                      <button className="cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width={110} height={110} viewBox="0 0 24 24" color="lightgray" fill="none" stroke="currentColor" strokeWidth={0.75} strokeLinecap="round" strokeLinejoin="round" className="icon icon-tabler icons-tabler-outline icon-tabler-report-money group-hover:stroke-green-400 transition-colors duration-300">
                          <path stroke="none" d="M0 0h24v24H0z" fill="none" />
                      ...
                      <h3 className="text-lg font-bold text-white group-hover:text-green-400 transition-colors duration-300">Sponsor</h3>
                    </div>
                  </div>
                </div>
              </div>
